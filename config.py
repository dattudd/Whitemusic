...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "💐⃝♥️𝙎𝙪𝙕𝙪𝙈𝙚 ♡ 𝙈𝙪𝙨𝙞𝙘𝄟⃟🦋")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Noobxcoders/IG_Music")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BewafaBeats")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Amazingdpzworld")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/418495b6d23cf81544e4f.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://graph.org/file/809c8ad934384c2f02088.jpg",
)
...
STATS_IMG_URL = "https://graph.org/file/809c8ad934384c2f02088.jpg"
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://graph.org/file/809c8ad934384c2f02088.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/418495b6d23cf81544e4f.jpg"
